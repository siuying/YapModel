Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/BluechipSystems/YapModel.git"
  ...
  s.source       = { :git => "https://github.com/BluechipSystems/YapModel.git", :tag => s.version.to_s }

  s.source_files  = 'source/**/*.{h,m}'
  s.requires_arc = true

  s.dependency 'YapDatabase/SQLCipher', '~> 2.9'
